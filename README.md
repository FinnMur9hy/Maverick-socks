...
> Prices and product photos in this repo are placeholders. Swap the images in
> `assets/` and the numbers in `products.js` for your live catalogue.

## Newsletter form

The signup form posts to a placeholder Formspree endpoint
...
or remove the `<section class="newsletter">` block.
